...
object Quote {
  ...
  val all = Vector(
    ...
    new Quote("A win by an unsound combination, however showy, fills me with artistic horror.",
              "Wilhelm Steinitz"),
    new Quote(
    ...
    new Quote(
      ...
      "Nigel Short"),
    new Quote("Life is a kind of chess, with struggle, competition, good and ill events.",
              "Benjamin Franklin"),
    new Quote(
    ...
    new Quote("The winner of the game is the player who makes the next-to-last mistake.",
              "Savielly Tartakover"),
    new Quote(
    ...
    new Quote("Its just you and your opponent at the board and you’re trying to prove something.",
              "Bobby Fischer"),
    new Quote(
    ...
    new Quote("Many have become chess masters, no one has become the master of chess.",
              "Siegbert Tarrasch"),
    new Quote(
      ...
      "Michael Stean"),
    new Quote("You have to have the fighting spirit. You have to force moves and take chances.",
              "Bobby Fischer"),
    new Quote(
    ...
    new Quote("Who is your opponent tonight, tonight I am playing against the black pieces.",
              "Akiba Rubinstein"),
    ...
    new Quote("If I win a tournament, I win it by myself.  I do the playing. Nobody helps me.",
              "Bobby Fischer"),
    ...
    new Quote("When the chess game is over, the pawn and the king go back to the same box.",
              "Irish saying"),
    new Quote(
    ...
    new Quote("I played chess with him and would have beaten him sometimes only he always took back his last move, and ran the game out differently.",
              "Mark Twain"),
    ...
    new Quote("Chess is a fighting game which is purely intellectual and includes chance.",
              "Richard Reti"),
    new Quote(
    ...
    new Quote("For me, chess is life and every game is like a new life. Every chess player gets to live many lives in one lifetime.",
              "Eduard Gufeld"),
    new Quote("Chess is a terrific way for kids to build self image and self esteem.",
              "Saudin Robovic"),
    ...
    new Quote(
      ...
      "Benjamin Franklin"),
    new Quote("The enormous mental resilience, without which no chess player can exist, was so much taken up by chess that he could never free his mind of this game.",
              "Albert Einstein"),
    new Quote(
    ...
    new Quote(
      ...
      "Emanuel Lasker"),
    new Quote("You know you’re going to lose. Even when I was ahead I knew I was going to lose  --on playing against Fischer.",
              "Andrew Soltis"),
    new Quote(
    ...
    new Quote("Fischer sacrificed virtually everything most of us weakies (to use his term) value, respect, and cherish, for the sake of an artful, often beautiful board game, for the ambivalent privilege of being its greatest master.",
              "Paul Kollar"),
    new Quote(
    ...
    new Quote("By this measure (on the gap between Fischer & his contemporaries), I consider him the greatest world champion.",
              "Garry Kasparov"),
    new Quote(
    ...
    new Quote("The laws of chess do not permit a free choice: you have to move whether you like it or not.",
              "Emanuel Lasker"),
    new Quote(
    ...
    new Quote(
      ...
      "Siegbert Tarrasch"),
    new Quote("Fischer was a master of clarity and a king of artful positioning. His opponents would see where he was going but were powerless to stop him.",
              "Bruce Pandolfini"),
    new Quote(
    ...
    new Quote("White lost because he failed to remember the right continuation and had to think up the moves himself.",
              "Siegbert Tarrasch"),
    new Quote(
    ...
    new Quote("These are not pieces, they are men! For any man to walk into the line of fire will be one less man in your army to fight for you. Value every troop and use him wisely, throw him not to the dogs as he is there to serve his king.",
              "Jamie Walter Adams"),
    new Quote("Chess isn’t a game of speed, it is a game of speech through actions.",
              "Matthew Selman"),
    new Quote(
    ...
    new Quote("Tactics... Tactics are your friends. But they are weird friends who do strange things.",
              "John ~ZugAddict~ Chernoff"),
    new Quote("You can't take the pawn because then the other will queen. Like wonder twin powers",
              "John ~ZugAddict~ Chernoff"),
    new Quote(
    ...
    new Quote(
      ...
      "Dan Heisman"),
    new Quote("I detest the endgame. A well-played game should be practically decided in the middlegame.",
              "David Janowski"),
    ...
    new Quote(
      ...
      "Viswanathan Anand"),
    new Quote("Having good strategies in playing chess is often a good indication of being focused in life.",
              "Martin Dansky"),
    new Quote(
    ...
    new Quote("Chess: It’s like alcohol. It’s a drug. I have to control it, or it could overwhelm me.",
              "Charles Krauthammer"),
    new Quote("Drawing general conclusions about your main weaknesses can provide a great stimulus to further growth.",
              "Alexander Kotov"),
    ...
    new Quote("Good players develop a tactical instinct, a sense of what is possible or likely and what is not worth calculating.",
              "Sam Reshevsky"),
    new Quote("Lack of patience is probably the most common reason for losing a game, or drawing games that should have been won.",
              "Bent Larsen"),
    new Quote(
    ...
    new Quote("The kings are an apt metaphor for human beings: utterly constrained by the rules of the game, defenseless against bombardment from all sides, able only to temporarily dodge disaster by moving one step in any direction.",
              "Jennifer duBois"),
    new Quote(
    ...
    new Quote("According to such great attacking players as Bronstein and Tal, most combinations are inspired by the player's memories of earlier games.",
              "Pal Benko"),
    new Quote("After I won the title, I was confronted with the real world. People do not behave naturally anymore – hypocrisy is everywhere.",
              "Boris Spassky"),
    ...
    new Quote("Althought the Knight is generally considered to be on a par with the Bishop in strength, the latter piece is somehat stronger in the majority of cases in which they are opposed to each other.",
              "Jose Capablanca"),
    new Quote("Amberley excelled at chess - a mark, Watson, of a scheming mind.",
    ...
    new Quote("As a rule, pawn endings have a forced character, and they can be worked out conclusively.",
              "Mark Dvoretsky"),
    new Quote("As a rule, so-called \"positional\" sacrifices are considered more difficult, and therefore more praise-worthy, than those which are based exclusively on an exact calculation of tactical possibilities.",
              "Alexander Alekhine"),
    new Quote(
    ...
    new Quote("Attackers may sometimes regret bad moves, but it is much worse to forever regret an opportunity you allowed to pass you by.",
              "Garry Kasparov"),
    new Quote("Avoidance of mistakes is the beginning, as it is the end, of mastery in chess.",
              "Eugene Znosko-Borovsky"),
    new Quote(
    ...
    new Quote("Chess can never reach its height by following in the path of science ... Let us, therefore, make a new effort and with the help of our imagination turn the struggle of technique into a battle of ideas.",
              "Jose Capablanca"),
    new Quote("Chess continues to advance over time, so the players of the future will inevitably surpass me in the quality of their play, assuming the rules and regulations allow them to play serious chess. But it will likely be a long time before anyone spends 20 consecutive years as number one, as I did.",
              "Garry Kasparov"),
    new Quote(
    ...
    new Quote("Chess is like a language, the top players are very fluent at it. Talent can be developed scientifically but you have to find first what you are good at.",
              "Viswanathan Anand"),
    new Quote("Chess is like body-building. If you train every day, you stay in top shape. It is the same with your brain – chess is a matter of daily training.",
              "Vladimir Kramnik"),
    ...
    new Quote("Here is a definition which correctly reflects the course of thought and action of a grandmaster: The plan in a game of chess is the sum total of successive strategical operations which are each carried out according to separate ideas arising from the demands of the position.",
              "Alexander Kotov"),
    new Quote("How come the little things bother you when you are in a bad position? They don't bother you in good positions.",
              "Yasser Seirawan"),
    new Quote("However hopeless the situation appears to be there yet always exists the possibility of putting up a stubborn resistance.",
              "Paul Keres"),
    new Quote("I ... have two vocations: chess and engineering. If I played chess only, I believe that my success would not have been significantly greater. I can play chess well only when I have fully convalesced from chess and when the 'hunger for chess' once more awakens within me.",
              "Mikhail Botvinnik"),
    ...
    new Quote(
      ...
      "Peter Svidler"),
    new Quote("Chess is a battle between your aversion to thinking and your aversion to losing.",
              "Someone"),
