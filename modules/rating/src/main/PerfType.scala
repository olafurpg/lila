...
object PerfType {
  ...
  case object Blitz
      extends PerfType(
        2, key = "blitz", name = Speed.Blitz.name, title = Speed.Blitz.title, iconChar = ')')
  ...
  case object Puzzle
      extends PerfType(
        20, key = "puzzle", name = "Training", title = "Training puzzles", iconChar = '-')

  case object Opening
      extends PerfType(
        21, key = "opening", name = "Opening", title = "Opening trainer", iconChar = ']')
