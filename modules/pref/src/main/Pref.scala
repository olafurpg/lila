...
object Pref {
  ...
  object AutoQueen {
    ...
    val choices = Seq(NEVER -> "Never", ALWAYS -> "Always", PREMOVE -> "When premoving")
  }
  ...
  object InsightShare {
    ...
    val choices = Seq(
      NOBODY -> "With nobody", FRIENDS -> "With friends", EVERYBODY -> "With everybody")
  }
  ...
  object AutoThreefold {
    ...
    val choices = Seq(
      NEVER -> "Never", ALWAYS -> "Always", TIME -> "When time remaining < 30 seconds")
  }
  ...
  object Takeback {
    ...
    val choices = Seq(NEVER -> "Never", ALWAYS -> "Always", CASUAL -> "In casual games only")
  }
  ...
  object Animation {
    ...
    val choices = Seq(NONE -> "None", FAST -> "Fast", NORMAL -> "Normal", SLOW -> "Slow")
  }
  ...
  object Coords {
    ...
    val choices = Seq(NONE -> "No", INSIDE -> "Inside the board", OUTSIDE -> "Outside the board")
  }
  ...
  object Replay {
    ...
    val choices = Seq(NEVER -> "Never", SLOW -> "On slow games", ALWAYS -> "Always")
  }
  ...
  object ClockTenths {
    ...
    val choices = Seq(
      NEVER -> "Never", LOWTIME -> "When time remaining < 10 seconds", ALWAYS -> "Always")
  }
  ...
  object Challenge {
    ...
    def block(
        from: User, to: User, pref: Int, follow: Boolean, fromCheat: Boolean): Option[String] =
      pref match {
  ...
  object Message {
    ...
    val choices = Seq(NEVER -> "Never", FRIEND -> "Only friends", ALWAYS -> "Always")
  }
