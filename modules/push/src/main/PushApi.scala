...
private final class PushApi(googlePush: GooglePush,
                            applePush: ApplePush,
          ...
          IfAway(pov) {
            pushToAll(userId,
                      ...
                      PushApi.Data(
                        ...
                        payload = Json.obj("userId" -> userId,
                                           "userData" -> Json.obj(
                                             "type" -> "gameFinish",
                                             "gameId" -> game.id,
                                             "fullId" -> pov.fullId,
      ...
      lightUser(challenger.id) ?? { lightChallenger =>
        pushToAll(
          ...
          PushApi.Data(
            ...
            payload = Json.obj("userId" -> dest.id,
