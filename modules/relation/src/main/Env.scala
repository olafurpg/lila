...
final class Env(config: Config,
  ...
  lazy val api = new RelationApi(coll = coll,
  ...
  private[relation] val actor = system.actorOf(Props(
                                                 new RelationActor(
...
object Env {
  ...
  lazy val current =
    "relation" boot new Env(config = lila.common.PlayApp loadConfig "relation",
