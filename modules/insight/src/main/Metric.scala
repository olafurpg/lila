...
object Metric {
  ...
  case object Result
      extends Metric(
        "result", "Game result", F.result, Game, Game, Percent, Dimension.Result.description)
  ...
  case object PieceRole
      extends Metric(
        "piece", "Piece moved", F moves "r", Move, Move, Percent, Dimension.PieceRole.description)
