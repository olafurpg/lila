...
sealed abstract class Dimension[A : BSONValueHandler](val key: String,
                                                      val name: String,
                                                      val dbKey: String,
...
object Dimension {
  ...
  case object Result
      extends Dimension[Result]("result",
                                "Game result",
                                F.result,
                                Game,
                                _.name,
  ...
  case object QueenTrade
      extends Dimension[QueenTrade]("queenTrade",
                                    "Queen trade",
                                    F.queenTrade,
                                    Game,
                                    _.name,
  ...
  def valueToJson[X](d: Dimension[X])(v: X): play.api.libs.json.JsObject = {
    play.api.libs.json.Json.obj("key" -> valueKey(d)(v), "name" -> d.valueName(v))
  }
