...
object PerfPicker {
  ...
  def perfType(
      speed: Speed, variant: chess.variant.Variant, daysPerTurn: Option[Int]): Option[PerfType] =
  ...
  def mainOrDefault(
      speed: Speed, variant: chess.variant.Variant, daysPerTurn: Option[Int]): Perfs => Perf =
