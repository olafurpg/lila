...
final class Env(config: Config,
  ...
  private val repo = new FishnetRepo(analysisColl = analysisColl, clientColl = clientColl)

  private val moveDb = new MoveDB(roundMap = hub.actor.roundMap, system = system)
  ...
  val api = new FishnetApi(repo = repo,
                           moveDb = moveDb,
