...
final class Env(
  ...
  lazy val pool =
    new I18nPool(langs = Lang.availables(play.api.Play.current).toSet, default = I18nKey.en)
  ...
  lazy val gitWrite =
    new GitWrite(transRelPath = FilePathRelative, repoPath = appPath, system = system)
